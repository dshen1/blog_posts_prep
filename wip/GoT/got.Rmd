...
predictions[grep("Walda", predictions$name), c(6, 12:13, 15, 34)] %>% arrange(name)
```
...
predictions[grep("Walton", predictions$name), c(6, 15:16)] %>% arrange(name)
```
...
characters$house2 <- ifelse(characters$house %in% c("House Targaryen", "House Stark", "House Tully", "House Lannister", "House Baratheon", "House Tyrell", "House Martell", "House Frey"), characters$house, NA)
```
...
```{r echo=FALSE, eval=FALSE}
save(colors_edges, file = "colors_edges.RData")
save(color_vertices, file = "color_vertices.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Stark, file = "graph_Stark.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Lannister, file = "graph_Lannister.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Baratheon, file = "graph_Baratheon.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Targaryen, file = "graph_Targaryen.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Tyrell, file = "graph_Tyrell.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Martell, file = "graph_Martell.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Tully, file = "graph_Tully.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Arryn, file = "graph_Arryn.RData")
```
...
```{r echo=FALSE, eval=FALSE}
save(graph_Frey, file = "graph_Frey.RData")
```
