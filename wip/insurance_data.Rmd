...
Accuracy is okay but for the example we are looking at, accuracy is not a good measure of performance. The class of interest, class 1 (customers who bought the insurance) never gets predicted because the model is biased towards the more common class.
