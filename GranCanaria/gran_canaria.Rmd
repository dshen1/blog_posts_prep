...
ggmap(map) + 
  geom_point(data = geodata_gc, aes(x = lon, y = lat), alpha = 0.3, color = "blue") +
  geom_point(data = loc_gc, aes(x = lon, y = lat), alpha = 0.3, color = "red") +
  geom_point(data = geodata_tracks, aes(x = lon, y = lat), alpha = 0.3, color = "black")
```
